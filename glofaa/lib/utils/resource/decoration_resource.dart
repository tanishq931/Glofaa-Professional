...
class DecorationResource {
  ...
  BoxDecoration decorationSearchBar() {
    return BoxDecoration(
        ...
        border: Border.all(color: ColorResource.catBorderColor, width: 1));
  }
  BoxDecoration decorationFilterTopBar() {
    return BoxDecoration(
      color: ColorResource.filterBarBackgroundColor.withOpacity(0.03),
    );
  }
  ...
  BoxDecoration decorationGreyedRoundedCorner() {
    return BoxDecoration(
        color: ColorResource.disableFieldGreyColor,
        border: Border.all(color: ColorResource.disableFieldGreyColor, width: 1),
        borderRadius: BorderRadius.circular(4));
  }
  BoxDecoration decorationBorderGreyed() {
    return BoxDecoration(
        border: Border.all(color: ColorResource.disableFieldGreyColor, width: 1));
  }
  ...
  BoxDecoration decorationDisabledFieldNoRadius() {
    return BoxDecoration(
        color: ColorResource.disableFieldGreyColor,
        border: Border.all(color: ColorResource.borderTextField, width: 1));
  }

  BoxDecoration decorationDisabledFieldRadius() {
    return BoxDecoration(
        color: ColorResource.disableFieldGreyColor,
        border: Border.all(color: ColorResource.borderTextField, width: 1),
        borderRadius: BorderRadius.circular(DimensionResource.buttonRadius));
  ...
  List<BoxShadow> containerBoxShadowBlack(){
    return const [BoxShadow(
      color: ColorResource.lightGrey,
      blurRadius: 10.0,
    ),];
