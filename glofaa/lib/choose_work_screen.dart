          ...
          children: [
           ...
           ListTile(
             ...
             trailing: Container(
               ...
               child: Center(
                 child: selectedIndex == 0 ? Image.asset("assets/images/Done.png"): null,
               ),
             ),
             onTap: (){
               setState(() {
            ...
            ListTile(
              ...
              trailing: Container(
                ...
                child: Center(
                  child: selectedIndex == 1 ? Image.asset("assets/images/Done.png"): null,
                ),
              ),
              onTap: (){
                setState(() {
            ...
            ListTile (
              ...
              trailing: Container(
                ...
                child: Center(
                  child: selectedIndex == 2 ? Image.asset("assets/images/Done.png"): null,
                ),
              ),
              onTap: (){
                setState(() {
                      ...
                      children: [
                        ListTile (
                          ...
                          trailing: Container(
                            ...
                            child: Center(
                              child: selectedIndex1 == index ? Image.asset("assets/images/Done.png"): null,
                            ),
                          ),
                          onTap: (){
                            setState(() {
